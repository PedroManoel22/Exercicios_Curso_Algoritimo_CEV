...
def resultado(jogada_usuario: str, jogada_computador: str) -> bool | int:
...
def exibir_dados(j_usuario: str, j_computador: str):
    print(
...
if __name__ == "__main__":
    while True:
        ...
        if ganhou == 0 and ganhou is not False:
