...
def calcular_valida_prestacao_mensal(
    valor_casa: float, salario: float, anos: int
) -> tuple[float, str]:
...
def exibir_dados(
    valor_casa: float, salario: float, anos: int, prestacao: float, resultado: str
):
    print("\n---- Dados ----\n")
    print(
        f"Valor do imóvel: R${valor_casa}\n"
        f"Salário: R${salario}\n"
