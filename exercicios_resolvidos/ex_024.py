...
def calcula_preco_passagem(distancia: float) -> float:
    if distancia <= 200:
...
def exibir_dados(distancia: float, preco: float):
    print("\n---- Dados da viagem ----\n")
    print(
        f"Sua viagem foi um total de {distancia} km\n"
