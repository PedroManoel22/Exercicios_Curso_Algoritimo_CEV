...
def quantidade_dias():
    while True:
        try:
            dias = int(
                input("Insira a quantidade de dias que você ficou com o carro: ")
            )
...
def custo_alocagem(kms_percorridos: float, dias: int):
    custo_dias = 90 * dias
...
def exibir_dados(kms_percorridos: float, dias: int, custo_final: float):
    print(
