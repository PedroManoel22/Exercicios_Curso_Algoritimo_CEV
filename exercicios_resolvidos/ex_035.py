...
def calcular_custo(tipo: int, dias: int, kms: float) -> float:
...
def exibir_dados(tipo: int | str, dias: int, kms: float, custo: float):
    if tipo == 1:
        tipo = "Popular"
